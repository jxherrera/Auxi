    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-card">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900">Catálogo de Insumos, Herramientas y Materiales</h2>
            <p className="text-xs text-slate-500">
              Control de stock, salidas en jornadas, costos unitarios y requerimientos de insumos de campo
            </p>
          </div>
        </div>
